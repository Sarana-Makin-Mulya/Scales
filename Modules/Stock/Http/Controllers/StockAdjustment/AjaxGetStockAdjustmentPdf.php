...
class AjaxGetStockAdjustmentPdf extends Controller
{
    protected $orderBy;
    ...
    public function __invoke(Request $request)
    {
        ...
        //return $data;
        //return view('stock::stock.export_adjustment_transaction_list_pdf', compact('data'));

        $pdf = PDF::loadView('stock::stock.export_adjustment_transaction_list_pdf', compact('data'));
        return $pdf->download();
    }
