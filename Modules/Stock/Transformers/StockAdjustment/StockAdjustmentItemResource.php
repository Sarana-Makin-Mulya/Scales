...
class StockAdjustmentItemResource extends Resource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'item_unit_conversion_id' => new ItemConversionResource($item_conversion),
            'item_unit_conversion' => getUnitConversionName($this->item_unit_conversion_id),
            'quantity' => $this->quantity,
            'stock_adjustment_category_id' => ['id' => $this->stock_adjustment_category_id, 'name' => getStockAdjustmentCategoryName($this->stock_adjustment_category_id)],
