...
class DetailSupplierResource extends Resource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'province' => $this->getAddress($this->code, 1,'province','text'),
            'city' => $this->getAddress($this->code, 1,'city','text'),
            ...
            'tax_province' => $this->getAddress($this->code, 2,'province','text'),
            'tax_city' => $this->getAddress($this->code, 2,'city','text'),
