            ...
            <div class="search-and-filter row mb-2 d-flex align-items-center">
                ...
                <div class="col-12 col-md-6 text-md-right">
                    <input
                        ...
                        placeholder="Cari barang penimbangan"
                        @change="search()"
                    >
                    <button
                            type="button"
                        ...
                        >
                            ...
                            <div class="dropdown-menu" role="menu" x-placement="bottom-start">
                                <a class="dropdown-item" href="#">
                                    <download-excel
                                        title = "Daftar barang penimbangan"
                                        :fetch   = "fetchData"
                                        :fields = "json_fields"
                        ...
                        <a
                            ...
                            data-toggle="tooltip"
                            title="Tambah Data barang penimbangan"
                        >
    ...
    data() {
        return {
            ...
            fields: [
                ...
                { key: 'code', label: 'Kode', thStyle: 'text-align: left;', tdClass: 'custom-cell text-left', sortable: true},
            ...
            fileName: 'master-barang-penimbangan' + moment().format("DD-MM-YYYY HH:MM")+ '.xls',
        }
    },
    methods: {
        rowClass(item, type) {
            if (!item || type !== 'row') return
            if (item.code == this.new_data)  return 'table-warning'
        },
        fetchData(ctx) {
        ...
        addForm(){
            this.modalTitle = 'Tambah Barang Penimbangan'
        ...
        editForm(item){
            this.modalTitle = 'Ubah Barang Penimbangan'
            this.$refs['bv-modal-add-form'].show()
        ...
        destroy(item) {
            this.$confirm('Apakah Anda yakin ingin menghapus "' + item.name + '" dari daftar barang penimbangan ?', 'Peringatan', {
        ...
        async submitForm() {
            ...
            axios({
                ...
                .then(response => {
                    ...
                    this.new_data = response.data.code
